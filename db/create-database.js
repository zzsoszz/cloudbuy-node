...
exports.createDatabase=function()
{
   ...
   return  schema.createTable('activity', function (table) {
      table.bigIncrements();
      ...
      table.timestamps();
    }).createTable('activity_ticket', function (table) {
      table.bigIncrements();
      ...
      table.timestamps();
    }).createTable('corder', function (table) {
      table.bigIncrements();
      ...
      table.timestamps();
    }).createTable('order_activity', function (table) {
      table.bigIncrements();
      table.bigInteger('activity_id').comment("活动编号");;
      ...
      table.bigInteger('modify_by_id');
      table.timestamps();
    }).createTable('cuser', function (table) {
      table.bigIncrements();
